...
// Serviço de análise financeira com integração às APIs
...
export const generateFinancialAnalysis = async (query: string): Promise<string> => {
  try {
    ...
    if (asset.includes('/')) {
      // Simula dados para par de moedas
      console.log(`Simulando dados para o par de moedas ${asset}`);
      ...
      // Simula dados para ações
      console.log(`Simulando dados para a ação ${asset}`);
